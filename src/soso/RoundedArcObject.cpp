...
:ArcObject(iOuterRadius,  iInnerRadius,  iStartAngle,  iEndAngle)
{
...
RoundedArcObject::~RoundedArcObject(){

}

/*
void RoundedArcObject::setResolution(int iRes)
{
...
void RoundedArcObject::setStartAngle(float iAngle)
{
	startAngle = ofDegToRad(iAngle);
}

void RoundedArcObject::setEndAngle(float iAngle)
{
