...
bool SosoTrueTypeFont::areMappedCharsBuilt = false;
vector<SosoMappedChar *> SosoTrueTypeFont::mappedChars;
vector<SosoMappedChar *> SosoTrueTypeFont::namedEntityChars;
...
SosoTrueTypeFont::SosoTrueTypeFont()
{
	buildMappedChars();
...
SosoTrueTypeFont::~SosoTrueTypeFont(){ //LM 070612
...
//-----------------------------------------------------------
bool SosoTrueTypeFont::loadFont(string filename, int fontsize, bool _bAntiAliased, bool _bFullCharacterSet, bool makeContours, bool makeMipMaps, float simplifyAmt, int dpi){	//soso - added makeMipMaps (see below)
	...
	if(!use_kerning) printf("SosoTrueTypeFont::loadFont() - kerning is NOT supported for %s\n", (char*)filename.c_str());
...
FT_UInt SosoTrueTypeFont::getFTCharIndex(FT_Face iFace, unsigned char iIndex)
{
...
void SosoTrueTypeFont::buildMappedChars()
{
	if(!areMappedCharsBuilt){
		...
		namedEntityChars.push_back(new SosoMappedChar(0x22, 0x0022, "&quot;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0x26, 0x0026, "&amp;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0x27, 0x0027, "&apos;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0x3C, 0x003C, "&lt;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0x3E, 0x003E, "&gt;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA0, 0x00A0, "&nbsp;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA1, 0x00A1, "&iexcl;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA2, 0x00A2, "&cent;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA3, 0x00A3, "&pound;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA4, 0x00A4, "&curren;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA5, 0x00A5, "&yen;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA6, 0x00A6, "&brvbar;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA7, 0x00A7, "&sect;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA8, 0x00A8, "&uml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xA9, 0x00A9, "&copy;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAA, 0x00AA, "&ordf;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAB, 0x00AB, "&laquo;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAC, 0x00AC, "&not;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAD, 0x00AD, "&shy;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAE, 0x00AE, "&reg;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xAF, 0x00AF, "&macr;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB0, 0x00B0, "&deg;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB1, 0x00B1, "&plusmn;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB2, 0x00B2, "&sup2;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB3, 0x00B3, "&sup3;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB4, 0x00B4, "&acute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB5, 0x00B5, "&micro;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB6, 0x00B6, "&para;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB7, 0x00B7, "&middot;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB8, 0x00B8, "&cedil;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xB9, 0x00B9, "&sup1;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBA, 0x00BA, "&ordm;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBB, 0x00BB, "&raquo;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBC, 0x00BC, "&frac14;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBD, 0x00BD, "&frac12;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBE, 0x00BE, "&frac34;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xBF, 0x00BF, "&iquest;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC0, 0x00C0, "&Agrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC1, 0x00C1, "&Aacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC2, 0x00C2, "&Acirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC3, 0x00C3, "&Atilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC4, 0x00C4, "&Auml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC5, 0x00C5, "&Aring;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC6, 0x00C6, "&AElig;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC7, 0x00C7, "&Ccedil;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC8, 0x00C8, "&Egrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xC9, 0x00C9, "&Eacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCA, 0x00CA, "&Ecirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCB, 0x00CB, "&Euml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCC, 0x00CC, "&lgrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCD, 0x00CD, "&lacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCE, 0x00CE, "&lcirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xCF, 0x00CF, "&luml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD0, 0x00D0, "&ETH;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD1, 0x00D1, "&Ntilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD2, 0x00D2, "&Ograve;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD3, 0x00D3, "&Oacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD4, 0x00D4, "&Ocirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD5, 0x00D5, "&Otilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD6, 0x00D6, "&Ouml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD7, 0x00D7, "&times;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD8, 0x00D8, "&Oslash;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xD9, 0x00D9, "&Ugrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDA, 0x00DA, "&Uacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDB, 0x00DB, "&Ucirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDC, 0x00DC, "&Uuml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDD, 0x00DD, "&Yacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDE, 0x00DE, "&THORN;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xDF, 0x00DF, "&szlig;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE0, 0x00E0, "&agrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE1, 0x00E1, "&aacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE2, 0x00E2, "&acirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE3, 0x00E3, "&atilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE4, 0x00E4, "&auml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE5, 0x00E5, "&aring;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE6, 0x00E6, "&aelig;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE7, 0x00E7, "&ccedil;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE8, 0x00E8, "&egrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xE9, 0x00E9, "&eacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xEA, 0x00EA, "&ecirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xEB, 0x00EB, "&euml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xEC, 0x00EC, "&igrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xED, 0x00ED, "&iacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xEE, 0x00EE, "&icirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xEF, 0x00EF, "&iuml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF0, 0x00F0, "&eth;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF1, 0x00F1, "&ntilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF2, 0x00F2, "&ograve;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF3, 0x00F3, "&oacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF4, 0x00F4, "&ocirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF5, 0x00F5, "&otilde;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF6, 0x00F6, "&ouml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF7, 0x00F7, "&divide;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF8, 0x00F8, "&oslash;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xF9, 0x00F9, "&ugrave;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFA, 0x00FA, "&uacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFB, 0x00FB, "&ucirc;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFC, 0x00FC, "&uuml;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFD, 0x00FD, "&yacute;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFE, 0x00FE, "&thorn;", 0x00));
		namedEntityChars.push_back(new SosoMappedChar(0xFF, 0x00FF, "&yuml;", 0x00));
		...
		mappedChars.push_back(new SosoMappedChar(0x7F, 0x0152, "&OElig;", 0xC5, 0x92));			//capital ligature OE
		mappedChars.push_back(new SosoMappedChar(0x80, 0x0153, "&oelig;", 0xC5, 0x93));			//small ligature oe
		mappedChars.push_back(new SosoMappedChar(0x81, 0x0160, "&Scaron;", 0xC5, 0xA0));			//capital letter S with caron
		mappedChars.push_back(new SosoMappedChar(0x82, 0x0161, "&scaron;", 0xC5, 0xA1));			//small letter s with caron
		mappedChars.push_back(new SosoMappedChar(0x83, 0x0178, "&Yuml;", 0xC5, 0xB8));			//capital Y with diaeresis
		mappedChars.push_back(new SosoMappedChar(0x84, 0x017D, "&#x17d;", 0xC5, 0xBD));			//capital letter Z with caron
		mappedChars.push_back(new SosoMappedChar(0x85, 0x017E, "&#x17e;", 0xC5, 0xBE));			//small letter z with caron
		mappedChars.push_back(new SosoMappedChar(0x86, 0x0192, "&fnof;", 0xC6, 0x92));			//small letter f with hook
		mappedChars.push_back(new SosoMappedChar(0x87, 0x02C6, "&#x5e;", 0x5E));					//circumflex
		mappedChars.push_back(new SosoMappedChar(0x88, 0x02DC, "&sim;", 0xE2, 0x88, 0xBC));		//tilde
		mappedChars.push_back(new SosoMappedChar(0x89, 0x2013, "&ndash;", 0xE2, 0x80, 0x93));	//en dash
		mappedChars.push_back(new SosoMappedChar(0x8A, 0x2014, "&mdash;", 0xE2, 0x80, 0x94));	//em dash
		mappedChars.push_back(new SosoMappedChar(0x8B, 0x2018, "&lsquo;", 0xE2, 0x80, 0x98));	//left single quotation mark
		mappedChars.push_back(new SosoMappedChar(0x8C, 0x2019, "&rsquo;", 0xE2, 0x80, 0x99));	//right single quotation mark
		mappedChars.push_back(new SosoMappedChar(0x8D, 0x201A, "&sbquo;", 0xE2, 0x80, 0x9A));	//single low quotation mark
		mappedChars.push_back(new SosoMappedChar(0x8E, 0x201C, "&ldquo;", 0xE2, 0x80, 0x9C));	//left double quotation mark
		mappedChars.push_back(new SosoMappedChar(0x8F, 0x201D, "&rdquo;", 0xE2, 0x80, 0x9D));	//right double quotation mark
		mappedChars.push_back(new SosoMappedChar(0x90, 0x201E, "&bdquo;", 0xE2, 0x80, 0x9E));	//double low quotation mark
		mappedChars.push_back(new SosoMappedChar(0x91, 0x2020, "&dagger;", 0xE2, 0x80, 0xA0));	//dagger
		mappedChars.push_back(new SosoMappedChar(0x92, 0x2021, "&Dagger;", 0xE2, 0x80, 0xA1));	//double dagger
		mappedChars.push_back(new SosoMappedChar(0x93, 0x2022, "&bull;", 0xE2, 0x80, 0xA2));		//bullet
		mappedChars.push_back(new SosoMappedChar(0x94, 0x2026, "&hellip;", 0xE2, 0x80, 0xA6));	//ellipsis
		mappedChars.push_back(new SosoMappedChar(0x95, 0x2030, "&permil;", 0xE2, 0x80, 0xB0));	//per mille
		mappedChars.push_back(new SosoMappedChar(0x96, 0x2039, "&lsaquo;", 0xE2, 0x80, 0xB9));	//single left pointing angle quotation mark
		mappedChars.push_back(new SosoMappedChar(0x97, 0x203A, "&rsaquo;", 0xE2, 0x80, 0xBA));	//single right pointing angle quotation mark
		//mappedChars.push_back(new SosoMappedChar(0x98, 0x20AC, "&euro;", 0xE2, 0x82, 0xAC));		//euro sign
        mappedChars.push_back(new SosoMappedChar(0x98, 0x00A3, "&pound;", 0xC2, 0xA3));		//pound sign    //eg 071012 - TEMP test for London
		mappedChars.push_back(new SosoMappedChar(0x99, 0x2122, "&trade;", 0xE2, 0x84, 0xA2));	//trademark sign
		mappedChars.push_back(new SosoMappedChar(0x9A, 0x25A1, "&#x25a1;", 0xE2, 0x96, 0xA1));	//white square
		mappedChars.push_back(new SosoMappedChar(0x9B, 0x25CA, "&loz;", 0xE2, 0x97, 0x8A));		//lozenge
		mappedChars.push_back(new SosoMappedChar(0x9C, 0x25E6, "&#x25e6;", 0xE2, 0x97, 0xA6));	//white bullet
		mappedChars.push_back(new SosoMappedChar(0x9D, 0xFB01, "&#xfb01;", 0xEF, 0xAC, 0x81));	//latin small ligature fi
		mappedChars.push_back(new SosoMappedChar(0x9E, 0xFB02, "&#xfb02;", 0xEF, 0xAC, 0x82));	//latin small ligature fl
...
int SosoTrueTypeFont::getMappedChar(string iString, int &iIndex)
{
	//Named entities
	if(iString[iIndex] == '&'){
		for(int i=0; i < mappedChars.size(); i++){
...
char* SosoTrueTypeFont::getMappedCharSequence(string iString, int &iIndex)   //eg 0701412
{
    //Named entities
	if(iString[iIndex] == '&'){
		for(int i=0; i < mappedChars.size(); i++){
...
void SosoTrueTypeFont::unloadTextures()
{
	if(!bLoadedOk) return;
...
void SosoTrueTypeFont::reloadTextures()
{
...
//sosolimited
float SosoTrueTypeFont::getKerningAdjustment(int c1, int c2)
{
...
//=====================================================================
void SosoTrueTypeFont::drawString(string c, float x, float y) {
...
void SosoTrueTypeFont::drawStringAsShapes(string c, float x, float y) {
...
//-----------------------------------------------------------
void SosoTrueTypeFont::drawChar(int c, float x, float y) {

    //printf("SosoTrueTypeFont::drawChar()\n");
...
float SosoTrueTypeFont::stringWidth(string c)
{
...
ofRectangle SosoTrueTypeFont::getStringBoundingBox(string c, float x, float y)
{
    ofRectangle myRect;
...
void SosoTrueTypeFont::replaceNamedEntities(string &iString)
{
	for(int i=0; i < namedEntityChars.size(); i++){
...
void SosoTrueTypeFont::removeCharacters(string &iString, string iCharsToRemove)
{
...
void SosoTrueTypeFont::enableKerning(bool iEnable)
{
	isKerningEnabled = iEnable;
}

//this method lets you do manual kerning
void SosoTrueTypeFont::setKerningPair(unsigned char iChar0, unsigned char iChar1, int iUnits)
{
...
void SosoTrueTypeFont::printNonzeroKerningPairs()
{
	for (int i = 0; i < FONT_NUM_CHARS; i++) {
		for (int j = 0; j < FONT_NUM_CHARS; j++) {
